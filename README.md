...
![Tests](https://github.com/cosmicrocks/scdl8/workflows/operator-tests/badge.svg)
![E2E Tests](https://github.com/cosmicrocks/scdl8/workflows/operator-e2e-tests/badge.svg)
[![Coverage Status](https://coveralls.io/repos/github/cosmicrocks/scdl8/badge.svg?branch=master)](https://coveralls.io/github/cosmicrocks/scdl8?branch=master)

<img src="docs/diagrams/logo.png" width="200">

The Postgres Operator delivers an easy to run highly-available [PostgreSQL](https://www.postgresql.org/)
clusters on Kubernetes (K8s) powered by [Patroni](https://github.com/cosmicrocks/patroni).
...
[WAL-E](https://github.com/wal-e/wal-e) via [Spilo](https://github.com/cosmicrocks/spilo)
...
The Postgres Operator has been developed at Cosmicrocks and is being used in
...
[scdl8.readthedocs.io](https://scdl8.readthedocs.io)
...
1. The [GitHub issue tracker](https://github.com/cosmicrocks/scdl8/issues)
2. The **#scdl8** [slack channel](https://postgres-slack.herokuapp.com)
