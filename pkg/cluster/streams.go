...
func (c *Cluster) createStreams(appId string) (*cosmicrocksv1.FabricEventStream, error) {
...
func (c *Cluster) updateStreams(newEventStreams *cosmicrocksv1.FabricEventStream) error {
...
func (c *Cluster) generateFabricEventStream(appId string) *cosmicrocksv1.FabricEventStream {
	eventStreams := make([]cosmicrocksv1.EventStream, 0)
	...
	for _, stream := range c.Spec.Streams {
		...
		for tableName, table := range stream.Tables {
			...
			eventStreams = append(eventStreams, cosmicrocksv1.EventStream{
	...
	return &cosmicrocksv1.FabricEventStream{
...
func (c *Cluster) getEventStreamSource(stream acidv1.Stream, tableName string, idColumn *string) cosmicrocksv1.EventStreamSource {
	table, schema := getTableSchema(tableName)
	streamFilter := stream.Filter[tableName]
	return cosmicrocksv1.EventStreamSource{
...
func getEventStreamFlow(stream acidv1.Stream, payloadColumn *string) cosmicrocksv1.EventStreamFlow {
	return cosmicrocksv1.EventStreamFlow{
		Type:          constants.EventStreamFlowPgGenericType,
		PayloadColumn: payloadColumn,
	}
}

func getEventStreamSink(stream acidv1.Stream, eventType string) cosmicrocksv1.EventStreamSink {
	return cosmicrocksv1.EventStreamSink{
...
func getOutboxTable(tableName string, idColumn *string) cosmicrocksv1.EventStreamTable {
	return cosmicrocksv1.EventStreamTable{
		Name:     tableName,
		IDColumn: idColumn,
	}
}
...
func (c *Cluster) getStreamConnection(database, user, appId string) cosmicrocksv1.Connection {
	return cosmicrocksv1.Connection{
...
func sameStreams(curEventStreams, newEventStreams []cosmicrocksv1.EventStream) (match bool, reason string) {
